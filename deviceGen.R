...
points<-c("NB003","NB018","NB031","NB034","QX002","QX012")
point<-filter(point,devicePointCode %in% points)

#使用readHistory获取测点数据
source('~/R/forecast/readHistory.R')
data<-devicechart(hdr,stationcode="3344112",device$deviceCode,startime,endtime,point$devicePointId)
describeBy(data[],group=data$deviceName)
